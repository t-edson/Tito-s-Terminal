...
Para las conexiones Telnet y SSH, usa el conocido "PLink" [link](http://the.earth.li/~sgtatham/putty/0.60/htmldoc/Chapter7.html), pero podría usarse otro cliente similar.
